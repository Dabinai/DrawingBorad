...
public class Main2Activity extends AppCompatActivity  implements View.OnClickListener, PaletteView.Callback,Handler.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar myToolbar = (Toolbar) findViewById(R.id.my2_toolbar);
            ...
            case R.id.save:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (savedFile != null) {
                            scanFile(Main2Activity.this, savedFile);
